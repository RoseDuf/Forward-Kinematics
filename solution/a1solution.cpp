...
bool A1Solution::changesWereMade()
{
...
void A1Solution::applyTransformations(QVector2D mouse_pos)
{
...
void A1Solution::Traverse(Joint2D* sibling, Matrix3d worldTransf)
{
    Joint * newJoint;
...
Matrix3d A1Solution::rotationTransformation(Matrix3d rotationMatrix, Joint2D* joint)
{
...
Matrix3d A1Solution::translationTransformation(QVector2D mouse_pos)
{
...
float A1Solution::getRotationAngle(QVector2D mouse_pos)
{
...
Vector2d A1Solution::convertToEigenMath(QVector2D vector)
{
    return Vector2d(vector.x(), -vector.y());
}

QVector2D A1Solution::convertToQtMath(Vector2d vector)
{
